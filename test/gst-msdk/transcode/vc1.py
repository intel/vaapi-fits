  ...
  def test_hwhw_1to1(self, case):
    ...
    vars(self).update(
      ...
      gsttrans     = "'video/x-wmv,profile=(string)advanced'"
                     ...
                     " ! msdkvc1dec ! msdkh264enc ! video/x-h264,profile=main"
...
class to_hevc(TranscoderTest):
  ...
  def test_hwhw_1to1(self, case):
    ...
    vars(self).update(
      ...
      gsttrans     = "'video/x-wmv,profile=(string)advanced'"
                     ",width={width},height={height},framerate=14/1"
                     " ! msdkvc1dec ! msdkh265enc ! video/x-h265,profile=main"
...
class to_mjpeg(TranscoderTest):
  ...
  def test_hwhw_1to1(self, case):
    ...
    vars(self).update(
      ...
      gsttrans     = "'video/x-wmv,profile=(string)advanced'"
                     ",width={width},height={height},framerate=14/1"
                     " ! msdkvc1dec ! msdkmjpegenc ! jpegparse".format(**vars(self)),
      gstdecoder1  = "'video/x-wmv,profile=(string)advanced'"
                     ",width={width},height={height},framerate=14/1"
                     " ! msdkvc1dec".format(**vars(self)),
...
class to_mpeg2(TranscoderTest):
  ...
  def test_hwhw_1to1(self, case):
    ...
    vars(self).update(
      ...
      gsttrans     = "'video/x-wmv,profile=(string)advanced'"
                     ",width={width},height={height},framerate=14/1"
                     " ! msdkvc1dec ! msdkmpeg2enc ! mpegvideoparse".format(**vars(self)),
      gstdecoder1  = "'video/x-wmv,profile=(string)advanced'"
                     ",width={width},height={height},framerate=14/1"
                     " ! msdkvc1dec".format(**vars(self)),
