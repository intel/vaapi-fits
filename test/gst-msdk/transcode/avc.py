...
class to_avc(TranscoderTest):
  ...
  def test_hwhw_1to1(self, case):
    ...
    vars(self).update(
      ...
      gsttrans     = 'h264parse ! msdkh264dec ! msdkh264enc ! video/x-h264,profile=main ! h264parse',
      gstdecoder1  = 'h264parse ! msdkh264dec',
  ...
  def test_hwsw_1to1(self, case):
    ...
    vars(self).update(
      ...
      mode         = 'hwsw',
      trans_type   = 'h264_to_h264',
      gsttrans     = 'h264parse ! msdkh264dec ! x264enc ! video/x-h264,profile=main ! h264parse',
      gstdecoder1  = 'h264parse ! msdkh264dec',
      gstdecoder2  = 'h264parse ! msdkh264dec',
    )
    self.transcode_1to1()
  ...
  def test_swhw_1to1(self, case):
    ...
    vars(self).update(
      ...
      mode         = 'swhw',
      trans_type   = 'h264_to_h264',
      gsttrans     = 'h264parse ! avdec_h264 ! msdkh264enc ! video/x-h264,profile=main ! h264parse',
      gstdecoder1  = 'h264parse ! msdkh264dec',
      gstdecoder2  = 'h264parse ! msdkh264dec',
    )
    self.transcode_1to1()
...
class to_hevc(TranscoderTest):
  ...
  def test_hwhw_1to1(self, case):
    ...
    vars(self).update(
      ...
      gsttrans     = 'h264parse ! msdkh264dec ! msdkh265enc ! video/x-h265,profile=main ! h265parse',
      gstdecoder1  = 'h264parse ! msdkh264dec',
  ...
  def test_hwsw_1to1(self, case):
    ...
    vars(self).update(
      ...
      mode         = 'hwsw',
      trans_type   = 'h264_to_h265',
      gsttrans     = 'h264parse ! msdkh264dec ! x265enc ! video/x-h265,profile=main ! h265parse',
      gstdecoder1  = 'h264parse ! msdkh264dec',
      gstdecoder2  = 'h265parse ! msdkh265dec',
    )
    self.transcode_1to1()
  ...
  def test_swhw_1to1(self, case):
    ...
    vars(self).update(
      ...
      mode         = 'swhw',
      trans_type   = 'h264_to_h265',
      gsttrans     = 'h264parse ! avdec_h264 ! msdkh265enc ! video/x-h265,profile=main ! h265parse',
      gstdecoder1  = 'h264parse ! msdkh264dec',
      gstdecoder2  = 'h265parse ! msdkh265dec',
    )
    self.transcode_1to1()
...
class to_mjpeg(TranscoderTest):
  ...
  def test_hwhw_1to1(self, case):
    ...
    vars(self).update(
      ...
      gsttrans     = 'h264parse ! msdkh264dec ! msdkmjpegenc ! jpegparse',
      gstdecoder1  = 'h264parse ! msdkh264dec',
  ...
  def test_hwsw_1to1(self, case):
    ...
    vars(self).update(
      ...
      mode         = 'hwsw',
      trans_type   = 'h264_to_mjpeg',
      gsttrans     = 'h264parse ! msdkh264dec ! jpegenc ! jpegparse',
      gstdecoder1  = 'h264parse ! msdkh264dec',
      gstdecoder2  = 'jpegparse ! msdkmjpegdec',
    )
    self.transcode_1to1()
  ...
  def test_swhw_1to1(self, case):
    ...
    vars(self).update(
      ...
      mode         = 'swhw',
      trans_type   = 'h264_to_mjpeg',
      gsttrans     = 'h264parse ! avdec_h264 ! msdkmjpegenc ! jpegparse',
      gstdecoder1  = 'h264parse ! msdkh264dec',
      gstdecoder2  = 'jpegparse ! msdkmjpegdec',
    )
    self.transcode_1to1()
...
class to_mpeg2(TranscoderTest):
  ...
  def test_hwhw_1to1(self, case):
    ...
    vars(self).update(
      ...
      gsttrans     = 'h264parse ! msdkh264dec ! msdkmpeg2enc ! mpegvideoparse',
      gstdecoder1  = 'h264parse ! msdkh264dec',
  ...
  def test_hwsw_1to1(self, case):
    ...
    vars(self).update(
      ...
      mode         = 'hwsw',
      trans_type   = 'h264_to_mpeg2',
      gsttrans     = 'h264parse ! msdkh264dec ! avenc_mpeg2video ! mpegvideoparse',
      gstdecoder1  = 'h264parse ! msdkh264dec',
      gstdecoder2  = 'mpegvideoparse ! msdkmpeg2dec',
    )
    self.transcode_1to1()
  ...
  def test_swhw_1to1(self, case):
    ...
    vars(self).update(
      ...
      mode         = 'swhw',
      trans_type   = 'h264_to_mpeg2',
      gsttrans     = 'h264parse ! avdec_h264 ! msdkmpeg2enc ! mpegvideoparse',
      gstdecoder1  = 'h264parse ! msdkh264dec',
      gstdecoder2  = 'mpegvideoparse ! msdkmpeg2dec',
    )
    self.transcode_1to1()
